module.exports = {
  ...
  async redirects() {
    return [
      ...
      { source: '/wednesday', destination: '/wednesdays-at-lh-fall-2024', permanent: true },
      ...
      { source: '/rhythms', destination: 'https://longhollow.com/rhythms-feb2024', permanent: true },
      ...
      { source: '/offering', destination: '/easteroffering', permanent: true },
      ...
      { source: '/notes', destination: 'http://bible.com/events/49323411', permanent: true }
    ];
  },
};
